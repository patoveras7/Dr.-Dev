    ...
    <div className="min-h-screen bg-clearIceFullLight">
      ...
      <section className="flex items-start justify-center px-4 sm:px-6 lg:px-8 pt-10 pb-[80px] sm:py-[45px] md:py-[55px] lg:py-[70px]">
        ...
        <button
          ...
          className="fixed z-50 right-20 top-2.5 sm:top-4 sm:right-24 md:top-6 md:right-[100px] lg:top-8 lg:right-[120px] xl:top-10 xl:right-[140px] bg-primary text-clearIce border-2 border-clearIce rounded-[7px] px-3 py-1 text-sm lg:text-base xl:text-lg font-medium hover:bg-clearIce hover:text-primary transition-all duration-200 shadow-lg"
        >
          inicio
        </button>
    </div>
